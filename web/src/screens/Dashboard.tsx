...
const Dashboard = () => {
  ...
  return (
    <div className="animate-in fade-in duration-300">
      {/* Hero Section */}
      <section className="gs-hero mb-10 relative overflow-hidden rounded-3xl bg-gradient-to-br from-indigo-500 via-purple-500 to-indigo-600 p-8 text-white shadow-xl shadow-indigo-500/20">
      ...
      <div className="grid grid-cols-3 gap-3 md:gap-6 mb-10">
        {[
          ...
          <div
            key={i}
            className="gs-stat glass-card rounded-2xl p-3 md:p-6 flex flex-col md:flex-row items-center gap-2 md:gap-4 group hover:-translate-y-1 transition-transform"
          >
      ...
      {/* Quick Access */}
      <h2 className="gs-qa-title text-2xl font-bold mb-6">Quick Access</h2>
      <div className="grid grid-cols-2 lg:grid-cols-3 gap-3 md:gap-6 mb-10">
        {[
          ...
          <button
            ...
            className={cn(
              'gs-qa-card rounded-2xl p-4 md:p-6 flex flex-col items-center justify-center text-center gap-3 md:gap-4 hover:-translate-y-1 transition-all group',
              'bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700',
              ['Listening', 'Reading', 'Writing Email'].includes(item.title)
